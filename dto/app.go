...
func (params *APPListInput) BindValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}

type AppListOutput struct {
	List  []AppListOutput `json:"list" form:"list" comment:"租户列表"`
...
func (params *APPDetailInput) BindValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}
...
func (params *APPAddHttpInput) BindValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}
